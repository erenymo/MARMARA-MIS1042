    ...
    internal class Program
    {
        static void Main(string[] args) // All C# programs starts with Main method.
        {
            ...
            */
            ...
            /* unassigned forms of integers - do not represent negative values*/
            ...
            */
            ...
            /*
            mutable - the value of the variable can change
            immutable - the value of the variable cannot change (const)
            ...
            */
            ...
            Method kullanmanın amacı, tekrar eden kod bloğunu tek bir methoda yazıp daha sonrasında istediğimiz yerde çağırmamızı sağlamaktır. (DRY (don't repeat yourself) prensibi)
            ...
            //PRODUCT NAMES
            string appleProd = "Apple";
            string pearProd = "Pear";
            string quinceProd = "Quince";
            string garlicProd = "Garlic";
            ...
            Report(appleProd, appleBasePrice2, VAT, currencyName2); // use the method name and paranthesis to call a method. 
            Report(pearProd, pearBasePrice2, VAT, currencyName2); // WE ARE PASSING THE ARGUMENTS TO THE METHOD
            Report(quinceProd, quinceBasePrice2, VAT, currencyName2);
            Report(garlicProd, garlicBasePrice2, VAT, currencyName2);

            // SCOPE  (iki süslü parantez arasına verilen isim. Degiskenlerin faaliyet alani)
            /*
             variables in one scope are not visible in another scope
             */
        }

        /*
        If you want a method to return value, you have to define the variable type(int, double, string) before the method name.
        ...
        When pass a paramtere to a method, it's called as argument
        parameters should be seperated by comas
         */

        static void Report(string productName ,float productPrice, float vat, string currencyName) // void keyword mean that this method will not return anything.
        {
            Console.WriteLine($"{productName} : {PriceCalculation(productPrice, vat)} {currencyName}");
        }

        static float PriceCalculation(float pPrice, float vt)
        {
            float finalPrice = pPrice * vt;
            return finalPrice;
        }
